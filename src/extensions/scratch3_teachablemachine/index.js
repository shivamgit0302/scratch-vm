...
class TeachableMachine {
    ...
    async initModel(modelUrl) {
      ...
      try {
          ...
          // Check if it's a pose model first
          if (customMobileNet._metadata.packageName === "@teachablemachine/pose") {
          ...
          } else if (customMobileNet._metadata.hasOwnProperty('tfjsSpeechCommandsVersion')) {
              ...
              this.latestAudioResults = {
                  scores: Array(wordLabels.length).fill(0),
              };
              return {
                  model: simulatedSpeechModel,
