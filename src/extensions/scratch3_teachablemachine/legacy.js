/* eslint-disable */
// scratch-vm/src/extensions/scratch3_teachablemachine/legacy.js
...
const legacyFullSupport = legacy(info);
const legacyIncrementalSupport = legacy(info, { "incrementalDevelopment": true });
